...
import { dalMedicoPart1 } from "./part1";
import { dalMedicoPart2 } from "./part2";
  ...
  reading: {
    ...
    sections: [
      ...
      },
      {
        ...
        headingFa: "علائم تنفسی و آنفولانزا",
      ...
      },
      {
        ...
        headingFa: "مشکلات گوارشی و پوستی",
      ...
      },
      {
        ...
        headingFa: "علائم مفصلی، عصبی و عمومی",
      ...
      },
      {
        ...
        headingFa: "علائم عضلانی، استخوانی و چشمی",
      ...
      },
      {
        ...
        headingFa: "علائم گوش و انواع درد",
      ...
      },
      {
        ...
        headingFa: "مکان‌ها، کارکنان حرفه‌ای و مدارک",
      ...
      },
      {
        ...
        headingFa: "حین ویزیت و عبارات مؤدبانه",
      ...
      },
      {
        ...
        headingFa: "تخصص‌های پزشکی در ایتالیا",
      ...
      {
        heading: "Vocabolario Dal Dottore e Specialità Mediche",
        headingFa: "واژگان پیش دکتر و تخصص‌های پزشکی",
      ...
      },
      {
        ...
        headingFa: "بیمار بودن و وسایل بیمارستان",
      ...
      },
      {
        ...
        headingFa: "انواع پزشکان و اصطلاحات بیمارستانی",
      ...
      {
        heading: "Espressioni Colloquiali dal Medico (Pagina 69)",
        headingFa: "اصطلاحات محاوره‌ای پزشکی",
        body: "1. Come ti senti?\n\"Cova qualcosa\": sta arrivando l'influenza.\n\"Sentirsi uno straccio\": sentirsi molto male/stanchi.\n\"Cerchio alla testa\": mal di testa forte.\n\"Pressione sotto i piedi\": sentirsi molto deboli.\n\n2. Dal Medico\n\"Farsi dare un'occhiata\": andare a farsi visitare.\n\"Fare un salto dal dottore\": andare dal medico velocemente.\n\"Dica 33\": frase del medico per controllare i polmoni.\n\"Fare l'impegnativa\": il foglio del medico per visite speciali.\n\n3. Cosa fare\n\"Stare a riposo\": stare a letto per guarire.\n\"Mettere il ghiaccio\": per botte o storte.\n\"Disinfettare\": pulire un taglio.\n\"Mettere un cerotto\": coprire una ferita.\n\n4. Frasi utili\n\"Colpo d'aria\": quando il freddo ti fa venire dolore.\n\"Notte in bianco\": quando non dormi per il dolore.\n\"Tornare in forma\": guarire e stare bene.\n\n5. Per i piccoli traumi\n\"Prendere una botta\": farsi male dopo un urto.\n\"Avere un bernoccolo\": il rigonfiamento sulla testa dopo un colpo.\n\"Prendere una storta\": girarsi la caviglia.\n\"Mettere la pomata\": spalmare la crema sul dolore.\n\n6. Sintomi veloci\n\"Avere le ossa rotte\": sentire dolore a tutto il corpo (influenza).\n\"Sentirsi mancare\": quando sembra di svenire.\n\"Avere la nausea\": sentire lo stomaco sottosopra.\n\"Essere a pezzi\": essere stanchissimi.\n\n7. Azioni rapide\n\"Prendere una pastiglia\": mangiare una medicina solida.\n\"Misurare la febbre\": usare il termometro.\n\"Stare al caldo\": non uscire per non peggiorare il raffreddore.\n\"Bere molto\": consiglio tipico per l'influenza o il caldo.\n\n8. Frasi del medico\n\"Faccia un bel respiro\": quando il medico ascolta i polmoni.\n\"Tiri fuori la lingua\": per guardare la gola.\n\"Si sdrai qui\": per farsi visitare sul lettino.",
        bodyFa: "۱. حالت چطوره?\n«یه چیزی داره میاد» (Cova qualcosa): داره آنفولانزا می‌گیری.\n«مثل دستمال کف‌شورم» (Sentirsi uno straccio): خیلی حالت بده/خسته‌ای.\n«دور سرم فشار داره» (Cerchio alla testa): سردرد شدید.\n«زیر پاهام فشار میاد» (Pressione sotto i piedi): خیلی ضعیفی.\n\n۲. پیش دکتر\n«یه نگاه بندازن» (Farsi dare un'occhiata): رفتن پیش دکتر برای معاینه.\n«یه سر به دکتر زدن» (Fare un salto dal dottore): سریع رفتن پیش دکتر.\n«بگید ۳۳» (Dica 33): جمله دکتر برای بررسی ریه‌ها.\n«گرفتن معرفی‌نامه» (Fare l'impegnativa): برگه دکتر برای ویزیت‌های تخصصی.\n\n۳. چیکار کنم\n«استراحت کردن» (Stare a riposo): تو تخت موندن برای بهبود.\n«یخ گذاشتن» (Mettere il ghiaccio): برای ضربه یا پیچ‌خوردگی.\n«ضدعفونی کردن» (Disinfettare): تمیز کردن بریدگی.\n«چسب زخم زدن» (Mettere un cerotto): پوشاندن زخم.\n\n۴. عبارات مفید\n«سرما خوردن از باد» (Colpo d'aria): وقتی سرما باعث درد می‌شه.\n«شب بیداری» (Notte in bianco): وقتی از درد نمی‌خوابی.\n«به فرم برگشتن» (Tornare in forma): خوب شدن و حالت بهتر شدن.\n\n۵. برای آسیب‌های کوچک\n«ضربه خوردن» (Prendere una botta): بعد از برخورد درد گرفتن.\n«قلنبه زدن» (Avere un bernoccolo): ورم روی سر بعد از ضربه.\n«مچ پا پیچ خوردن» (Prendere una storta): پیچ خوردن مچ پا.\n«پماد زدن» (Mettere la pomata): کرم مالیدن روی درد.\n\n۶. علائم سریع\n«استخون‌هام درد می‌کنه» (Avere le ossa rotte): درد تمام بدن (آنفولانزا).\n«حس غش کردن» (Sentirsi mancare): انگار داری از حال می‌ری.\n«حالت تهوع» (Avere la nausea): معده‌ات زیر و رو شده.\n«داغونم» (Essere a pezzi): خیلی خسته‌ای.\n\n۷. کارهای سریع\n«قرص خوردن» (Prendere una pastiglia): داروی جامد خوردن.\n«تب گرفتن» (Misurare la febbre): استفاده از دماسنج.\n«گرم موندن» (Stare al caldo): بیرون نرفتن تا سرما بدتر نشه.\n«زیاد آب خوردن» (Bere molto): توصیه معمول برای آنفولانزا یا گرما.\n\n۸. جملات دکتر\n«یه نفس عمیق بکشید» (Faccia un bel respiro): وقتی دکتر ریه‌ها رو گوش می‌ده.\n«زبونتون رو بیرون بیارید» (Tiri fuori la lingua): برای دیدن گلو.\n«اینجا دراز بکشید» (Si sdrai qui): برای معاینه روی تخت.",
        keywords: ["cova qualcosa","straccio","cerchio alla testa","dica 33","impegnativa","cerotto","colpo d'aria","notte in bianco","bernoccolo","storta","pastiglia","termometro"],
      },
      {
        heading: "Espressioni Idiomatiche dal Dottore (Pagine 70-71)",
        headingFa: "اصطلاحات اصطلاحی مربوط به دکتر",
        body: "In italiano esistono numerose espressioni colloquiali e idiomatiche per raccontare cosa è successo dal dottore.\n\nPer dire che non stai bene (Prima di andare):\n• \"Non essere in forma\" / \"Sentirsi uno straccio\": Sentirsi molto stanchi o malaticci.\n• \"Cova qualcosa\": Quando senti che sta per arrivarti l'influenza (\"Secondo me Marco cova qualcosa, ha una brutta cera\").\n• \"Avere un cerchio alla testa\": Avere un mal di testa che sembra stringere la fronte.\n\"Sentirsi un po' così\": Un modo vago per dire che non sei al 100%.\n\nAndare o Prenotare una Visita:\n• \"Vado a farmi dare un'occhiata\": Significa andare dal medico per un controllo generico.\n• \"Andare dal medico di base/di famiglia\": Il primo punto di riferimento.\n• \"Passare allo studio\": Andare direttamente dal medico.\n\nPer dire che vai dal medico:\n• \"Fare un salto dal dottore\": Andarci velocemente, spesso per una cosa di poco conto.\n• \"Farsi dare un'occhiata\": Chiedere un parere medico senza troppa ansia.\n• \"Andare a farsi scrivere le ricette\": Andare dal medico di base solo per i farmaci abituali.\n\nDurante la Visita Medica (Cosa succede):\n• \"Dica 33\": La frase tipica che il medico dice per controllare la respirazione e la gola.\n• \"Mi ha prescritto...\": Il medico ha scritto una ricetta per farmaci.\n• \"Fare l'impegnativa\": Quando il medico di base scrive la richiesta per una visita specialistica.\n• \"Mi ha fatto una puntura/un'iniezione\": Somministrazione di un farmaco.\n• \"Farmi i raggi/la radiografia\": Esame diagnostico comune.\n• \"Tastare il polso/il terreno\": Usato a volte figurativamente per intendere che il medico sta valutando la situazione.\n\nRaccontare com'è andata (Dopo la visita):\n• \"Mi ha rivoltato come un calzino\": Mi ha fatto una visita lunghissima e super approfondita.\n• \"Mi ha messo a stecchetto\": Il medico mi ha dato una dieta ferrea.\n• \"È tutto ok, sono sano come un pesce\": Sono in ottima salute.\n• \"Mi ha dato una sfilza di esami\": Mi ha prescritto tantissime analisi da fare.\n• \"Mi ha messo in mutua / mi ha dato i giorni\": Mi ha dato il certificato per stare a casa dal lavoro.\n\nDurante la visita (Cosa dire o sentirsi dire):\n• \"Dica trentatré\": Il classico stereotipo del medico che controlla i polmoni (anche se oggi si usa meno).\n• \"Spogliarsi fino alla cintola\": Togliersi la maglia per farsi auscultare.\n• \"Cosa sente?\": Il medico che chiede dove fa male, visita lunghissima e super approfondita.\n\nRaccontare i Sintomi o l'Esito:\n• \"Mi fa male [parte del corpo]\" / \"Ho un dolore a...\": La forma più semplice e comune per descrivere un problema.\n• \"Ho preso freddo\": Spiegazione classica per mal di gola o raffreddore.\n• \"Sono a pezzi\" / \"Sono giù\": Espressione colloquiale per dire che ci si sente molto male o molto stanchi.\n• \"Ho la febbre a 38\" (o \"Ho un po' di febbre\").\n• \"Mi ha detto che è [malattia]\" (es. \"Mi ha detto che è una forma virale\").\n• \"Non ho niente di grave\": Rassicurazione comune.\n• \"Devo fare un ciclo di [terapia]\": Seguire una cura per un certo periodo.\n• \"Mi ha messo a riposo\": Il medico ha consigliato di non lavorare/andare a scuola.\n• \"Il medico mi ha segnato/prescritto...\": Usato per indicare la ricetta medica.",
        bodyFa: "در ایتالیایی اصطلاحات محاوره‌ای و اصطلاحی زیادی برای تعریف کردن ماجرای دکتر رفتن وجود داره.\n\nبرای گفتن حالت خوب نیست (قبل از رفتن):\n• «در فرم نبودن» / «مثل دستمال بودن»: خیلی خسته یا ناخوش بودن.\n• «یه چیزی داره میاد» (Cova qualcosa): وقتی حس می‌کنی آنفولانزا در راهه.\n• «دور سرم حلقه زده» (Avere un cerchio alla testa): سردردی که انگار پیشونیت رو فشار می‌ده.\n«یه جوری‌ام» (Sentirsi un po' così): یه روش مبهم برای گفتن صد در صد نیستی.\n\nرفتن یا نوبت گرفتن:\n• «میرم یه نگاه بندازن» (Farmi dare un'occhiata): رفتن پیش دکتر برای یه چکاپ کلی.\n• «رفتن پیش دکتر خانوادگی» (Andare dal medico di base): اولین مرجع.\n• «رفتن به مطب» (Passare allo studio): مستقیم رفتن پیش دکتر.\n\nبرای گفتن داری میری دکتر:\n• «یه سر به دکتر زدن» (Fare un salto dal dottore): سریع رفتن، معمولاً برای چیز کوچیک.\n• «یه نگاه بندازن» (Farsi dare un'occhiata): نظر پزشکی گرفتن بدون استرس زیاد.\n• «رفتن نسخه نوشتن» (Andare a farsi scrivere le ricette): فقط برای داروهای همیشگی.\n\nحین ویزیت (چی اتفاق می‌افته):\n• «بگید ۳۳» (Dica 33): جمله معروف دکتر برای بررسی تنفس و گلو.\n• «برام نوشت...» (Mi ha prescritto): دکتر نسخه دارو نوشته.\n• «معرفی‌نامه گرفتن» (Fare l'impegnativa): وقتی دکتر برای ویزیت تخصصی درخواست می‌نویسه.\n• «آمپول زد» (Mi ha fatto una puntura): تزریق دارو.\n• «عکس/رادیوگرافی گرفتن» (Farmi i raggi): آزمایش تشخیصی رایج.\n• «نبض گرفتن» (Tastare il polso): گاهی مجازی یعنی دکتر داره وضعیت رو ارزیابی می‌کنه.\n\nتعریف کردن بعد از ویزیت:\n• «منو مثل جوراب برگردوند» (Mi ha rivoltato come un calzino): ویزیت خیلی طولانی و دقیق.\n• «رژیم سخت داد» (Mi ha messo a stecchetto): دکتر رژیم سفت و سخت داد.\n• «همه چیز خوبه، سالم سالمم» (Sono sano come un pesce): سلامتیم عالیه.\n• «کلی آزمایش داد» (Mi ha dato una sfilza di esami): خیلی آنالیز تجویز کرد.\n• «مرخصی استعلاجی داد» (Mi ha messo in mutua): گواهی برای نرفتن سر کار.\n\nحین ویزیت (چی بگی یا بشنوی):\n• «بگید سی و سه» (Dica trentatré): کلیشه کلاسیک دکتر برای بررسی ریه‌ها.\n• «تا کمر لباس در بیارید» (Spogliarsi fino alla cintola): لباس درآوردن برای معاینه.\n• «چی حس می‌کنید؟» (Cosa sente?): دکتر می‌پرسه کجا درد داره.\n\nتعریف علائم یا نتیجه:\n• «[عضو بدن] درد می‌کنه» / «یه درد دارم...»: ساده‌ترین شکل توصیف مشکل.\n• «سرما خوردم» (Ho preso freddo): توضیح کلاسیک گلودرد یا سرماخوردگی.\n• «داغونم» / «حالم خرابه» (Sono a pezzi / Sono giù): حال خیلی بد.\n• «تبم ۳۸ هست» (Ho la febbre a 38).\n• «گفت [بیماری] هست» (Mi ha detto che è...).\n• «چیز مهمی نیست» (Non ho niente di grave): دلداری معمول.\n• «باید یه دوره [درمان] انجام بدم» (Devo fare un ciclo di...).\n• «استراحت داد» (Mi ha messo a riposo): دکتر توصیه کرد کار نکنم.\n• «دکتر برام نوشت/تجویز کرد...» (Il medico mi ha segnato/prescritto...).",
        keywords: ["cova qualcosa","straccio","cerchio alla testa","dica 33","impegnativa","sano come un pesce","mutua","stecchetto","puntura","radiografia","prescritto","riposo"],
      },
      {
        heading: "Abitudini e Tratti Culturali Principali (Pagina 72)",
        headingFa: "عادات و ویژگی‌های فرهنگی اصلی",
        body: "Il Medico di Base come punto di riferimento: Per gli italiani il \"medico di famiglia\" è quasi un confessore. Si tende ad avere un rapporto di lunghissima durata; lui conosce la storia di tutta la famiglia.\n\nLa cultura della \"chiacchierata\": Non si va dritti al punto. È normale iniziare con un saluto cordiale e due parole sulla situazione generale prima di descrivere i sintomi. La comunicazione è molto empatica.\n\nIl \"pezzo di carta\": Nonostante la ricetta elettronica, molti pazienti (soprattutto i più anziani) tengono molto al promemoria cartaceo e alle indicazioni scritte a mano dal dottore.\n\nFidacia nel parere, meno nella puntualità: C'è un grande rispetto per l'autorità del medico, ma allo stesso tempo ci si aspetta flessibilità. Le sale d'attesa sono spesso luoghi di socializzazione involontaria dove si scambiano opinioni sui malanni.\n\nLa prevenzione \"fai da te\": Prima di andare dal medico, l'italiano medio ha già chiesto consiglio alla madre, alla farmacia sotto casa o ha cercato su Google, arrivando in studio con una mezza idea della diagnosi.\n\nLinguaggio figurato: Si usano espressioni tipiche come \"mi sento un peso allo stomaco\" o \"ho preso un colpo d'aria\", concetti culturali molto forti in Italia (come la famosa cervicale).",
        bodyFa: "دکتر خانوادگی به عنوان مرجع: برای ایتالیایی‌ها «دکتر خانوادگی» تقریباً مثل یه محرم اسرار هست. معمولاً رابطه خیلی طولانی دارن؛ اون تاریخچه کل خانواده رو می‌شناسه.\n\nفرهنگ «گپ زدن»: مستقیم نمیرن سر اصل مطلب. طبیعیه که با یه سلام گرم و چند کلمه درباره وضع کلی شروع کنن قبل از توصیف علائم. ارتباط خیلی همدلانه‌ست.\n\n«تکه کاغذ»: با وجود نسخه الکترونیکی، خیلی از بیمارها (مخصوصاً مسن‌ترها) به یادداشت کاغذی و دستورات دست‌نویس دکتر خیلی اهمیت می‌دن.\n\nاعتماد به نظر، کمتر به وقت‌شناسی: احترام زیادی به اقتدار دکتر هست، اما همزمان انعطاف‌پذیری هم انتظار می‌ره. اتاق‌های انتظار اغلب جاهایی هستن که ناخواسته درباره بیماری‌ها با هم حرف می‌زنن.\n\nپیشگیری «خودساخته»: قبل از رفتن پیش دکتر، ایتالیایی معمولی قبلاً از مادرش، داروخانه محله یا گوگل مشورت گرفته و با یه ایده نصفه‌نیمه از تشخیص میاد مطب.\n\nزبان تصویری: از عبارات معمولی مثل «احساس سنگینی معده می‌کنم» یا «سرما خوردم از باد» استفاده می‌شه، مفاهیم فرهنگی خیلی قوی در ایتالیا (مثل cervicale معروف).",
        keywords: ["medico di famiglia","chiacchierata","ricetta elettronica","sala d'attesa","prevenzione","colpo d'aria","cervicale"],
      },
      {
        heading: "Compiti Standardi — L'appuntamento con il medico (Pagina 73)",
        headingFa: "تکالیف استاندارد — قرار ملاقات با دکتر",
        body: "Fare i compiti è considerato un elemento essenziale per un training efficace. Proprio come nell'allenamento fisico, la ripetizione e l'impegno costante permettono al cervello di \"metabolizzare\" le nuove informazioni.\n\nIn un contesto di Situational Training, i compiti non sono semplici esercizi teorici, ma simulazioni pratiche progettate per prepararti a scenari reali. L'obiettivo è passare dal \"sapere\" al \"saper fare\".",
        bodyFa: "انجام تکالیف یک عنصر ضروری برای آموزش مؤثر محسوب می‌شه. درست مثل تمرین بدنی، تکرار و تلاش مداوم به مغز اجازه می‌ده اطلاعات جدید رو «هضم» کنه.\n\nدر چارچوب آموزش موقعیتی، تکالیف تمرین‌های ساده نظری نیستن، بلکه شبیه‌سازی‌های عملی هستن که برای آماده‌سازی شما برای سناریوهای واقعی طراحی شدن. هدف اینه که از «دانستن» به «توانستن» برسیم.",
        keywords: ["compiti","training","ripetizione","simulazioni pratiche","scenari reali","saper fare"],
      },
      {
        heading: "Curiosità Culturali sulla Medicina in Italia (Pagina 74)",
        headingFa: "نکات فرهنگی جالب درباره پزشکی در ایتالیا",
        body: "Piccola curiosità: i \"pazienti\" diventano \"assistiti\"\nSebbene nel linguaggio comune si dica sempre \"paziente\", burocraticamente verrai spesso chiamato \"persona assistita\" o semplicemente \"assistito\", per sottolineare il diritto alla cura garantito dallo Stato.\n\nAltri curiosità culturali:\nIl \"colpo d'aria\": Molti italiani attribuiscono piccoli malesseri (dolori cervicali o raffreddori) al \"colpo d'aria\" o alla \"cervicale\", concetti che a volte i medici stessi assecondano nella conversazione colloquiale.\n\nL'abbigliamento: I pazienti italiani tendono a preferire medici che indossano il camice bianco bottonato, simbolo di professionalità e ordine.\n\nIl medico come \"prescrittore\" di ricette:\nSpesso si va dal medico non per una visita, ma per farsi \"scrivere le ricette\" (prescrizioni). Il \"Ticket\": Con la ricetta del medico di base, si paga solo una piccola quota (il ticket) per esami o specialisti nel sistema pubblico.\n\nIl telefono: Non sorprenderti se, mentre sei a visita, il medico risponde al telefono ad altri pazienti, è un'abitudine comune per gestire brevi consulti o richieste di farmaci.",
        bodyFa: "نکته جالب: «بیمارها» می‌شن «تحت پوشش»\nاگرچه در زبان روزمره همیشه «بیمار» (paziente) گفته می‌شه، اما از نظر اداری اغلب «شخص تحت پوشش» (assistito) خطاب می‌شی، برای تأکید بر حق درمان تضمین‌شده توسط دولت.\n\nنکات فرهنگی دیگر:\n«سرما از باد» (Colpo d'aria): خیلی از ایتالیایی‌ها ناراحتی‌های کوچک (دردهای گردن یا سرماخوردگی) رو به «باد سرد» یا «سرویکال» نسبت می‌دن، مفاهیمی که گاهی خود دکترها هم در مکالمه محاوره‌ای تأیید می‌کنن.\n\nلباس: بیماران ایتالیایی ترجیح می‌دن دکترهایی که روپوش سفید دکمه‌دار می‌پوشن رو ببینن، نماد حرفه‌ای بودن و نظم.\n\nدکتر به عنوان «نسخه‌نویس»:\nاغلب پیش دکتر نه برای ویزیت، بلکه برای «نسخه نوشتن» میرن. «تیکت» (Ticket): با نسخه دکتر خانوادگی، فقط مبلغ کمی برای آزمایش‌ها یا متخصص‌ها در سیستم دولتی پرداخت می‌شه.\n\nتلفن: تعجب نکن اگه حین ویزیت دکتر جواب تلفن بیمارهای دیگه رو بده، این یه عادت معمول برای مدیریت مشاوره‌های کوتاه یا درخواست دارو هست.",
        keywords: ["assistito","colpo d'aria","cervicale","camice bianco","ricette","ticket","prescrizioni"],
      },
      {
        heading: "Esercizi: Completa le Frasi e Descrivi il Sintomo (Pagina 75)",
        headingFa: "تمرین‌ها: جملات را کامل کن و علائم را توصیف کن",
        body: "COMPLETA LE FRASI (Mi fa male / Ho dolore)\nUsa le espressioni corrette. Ricorda: Mi fa male + singolare / Mi fanno male + plurale.\n\nHo camminato per 10 chilometri e ora ……………… i piedi.\nHo mangiato troppo gelato e ……………… lo stomaco.\nHo lavorato tutto il giorno al computer e ……………… il collo.\nHo preso freddo e ora ……………… la gola.\nDopo l'allenamento in palestra ……………… le spalle.\n\nDAL MEDICO: DESCRIVI IL SINTOMO\nAbbina il problema (A-E) alla descrizione corretta (1-5).\n\nProblema / Descrizione:\nA. L'influenza — 1. \"Sento un battito forte nella testa.\"\nB. Il mal di denti — 2. \"Ho la tosse e mi fa male la gola.\"\nC. L'emicrania — 3. \"Ho dolore quando mastico o mangio cose fredde.\"\nD. Il raffreddore — 4. \"Ho la febbre alta e mi fanno male tutte le ossa.\"\nE. La gastrite — 5. \"Sento bruciore allo stomaco dopo i pasti.\"\n\nPRODUZIONE SCRITTA\nScrivi un breve dialogo (minimo 4 battute) tra un medico e un paziente.\nMedico: Chiede cosa c'è che non va.\nPaziente: Indica la parte del corpo e da quanto tempo ha dolore.\nMedico: Dà un consiglio o una medicina.",
        bodyFa: "جملات را کامل کنید (Mi fa male / Ho dolore)\nاز عبارات صحیح استفاده کنید. یادتان باشد: Mi fa male + مفرد / Mi fanno male + جمع.\n\n۱۰ کیلومتر راه رفتم و حالا ……………… پاهایم.\nخیلی بستنی خوردم و ……………… معده‌ام.\nتمام روز با کامپیوتر کار کردم و ……………… گردنم.\nسرما خوردم و حالا ……………… گلویم.\nبعد از تمرین در باشگاه ……………… شانه‌هایم.\n\nپیش دکتر: علائم را توصیف کن\nمشکل (A-E) را با توصیف صحیح (1-5) جفت کنید.\n\nمشکل / توصیف:\nA. آنفولانزا — ۱. «تپش شدیدی تو سرم حس می‌کنم.»\nB. دندان‌درد — ۲. «سرفه دارم و گلوم درد می‌کنه.»\nC. میگرن — ۳. «وقتی جویدن می‌کنم یا چیز سرد می‌خورم درد دارم.»\nD. سرماخوردگی — ۴. «تب بالا دارم و همه استخون‌هام درد می‌کنه.»\nE. گاستریت — ۵. «بعد از غذا سوزش معده حس می‌کنم.»\n\nنوشتن\nیک دیالوگ کوتاه (حداقل ۴ جمله) بین دکتر و بیمار بنویسید.\nدکتر: می‌پرسه چه مشکلی داری.\nبیمار: عضو بدن و مدت زمان درد رو می‌گه.\nدکتر: توصیه یا دارو می‌ده.",
        keywords: ["mi fa male","mi fanno male","influenza","mal di denti","emicrania","raffreddore","gastrite","battito","tosse","bruciore"],
      },
      {
        heading: "Esercizi Scritti (Pagine 76-77)",
        headingFa: "تمرین‌های نوشتاری",
        body: "1. Il Questionario dell'Anamnesi (Comprensione e Scrittura)\nImmagina di essere nella sala d'attesa. Compila questo modulo con i tuoi dati reali o inventati:\n\nSintomi principali: ___\nDa quanto tempo persistono i disturbi? ___\nAssume farmaci abitualmente? Se sì, quali? ___\nSoffre di allergie a farmaci o alimenti? ___\nHa avuto interventi chirurgici in passato? ___\n\n2. L'Agenda del Medico (Trasformazione da \"tu\" a \"Lei\")\nTrasforma queste richieste informali in frasi educate e formali da usare durante la visita:\n\nVoglio una ricetta per lo sciroppo.\n→ Mi scusi, potrebbe farmi una ricetta per lo sciroppo?\n\nSpiegami questa cosa.\n→ ___\n\nHo male qui.\n→ ___\n\nVoglio sapere quando fare gli esami.\n→ ___\n\n3. Ricostruzione del Dialogo (Logica Situazionale)\nRiordina le battute del dialogo tra il Dottore (D) e il Paziente (P):\n\n(__) P: Mi fa male la gola e ho la febbre da ieri.\n(__) D: Buongiorno, si sieda. Cosa succede?\n(__) P: Va bene, grazie Dottore. Arrivederci.\n(__) D: Prenda questo antibiotico ogni 12 ore per 5 giorni.\n(__) D: Vediamo... apra la bocca e dica \"AAA\". È molto infiammata.\n\n4. Il Messaggio alla Reception (Produzione Scritta)\nScrivi una breve email o un messaggio WhatsApp alla segreteria del medico per chiedere un appuntamento.\nIncludi:\n• Il motivo (es: controllo, forte mal di schiena).\n• La tua disponibilità di orario (es: solo il pomeriggio).\n• Una richiesta di conferma.",
        bodyFa: "۱. پرسشنامه سابقه پزشکی (درک مطلب و نوشتن)\nتصور کنید در اتاق انتظار هستید. این فرم را با اطلاعات واقعی یا ساختگی پر کنید:\n\nعلائم اصلی: ___\nاز چه مدت ناراحتی‌ها ادامه دارد؟ ___\nآیا به طور مرتب دارو مصرف می‌کنید؟ اگر بله، کدام؟ ___\nآیا به دارو یا غذا آلرژی دارید؟ ___\nآیا در گذشته عمل جراحی داشته‌اید؟ ___\n\n۲. دفترچه دکتر (تبدیل از «تو» به «شما»)\nاین درخواست‌های غیررسمی را به جملات مؤدبانه و رسمی برای استفاده حین ویزیت تبدیل کنید:\n\nمی‌خوام یه نسخه برای شربت.\n← ببخشید، می‌شه لطفاً برام یه نسخه برای شربت بنویسید?\n\nاین رو برام توضیح بده.\n← ___\n\naینجام درد می‌کنه.\n← ___\n\nمی‌خوام بدونم کی آزمایش بدم.\n← ___\n\n۳. بازسازی دیالوگ (منطق موقعیتی)\nجملات دیالوگ بین دکتر (D) و بیمار (P) را مرتب کنید:\n\n(__) P: گلوم درد می‌کنه و از دیروز تب دارم.\n(__) D: سلام، بفرمایید بشینید. چی شده?\n(__) P: باشه، ممنون دکتر. خداحافظ.\n(__) D: این آنتی‌بیوتیک رو هر ۱۲ ساعت به مدت ۵ روز بخورید.\n(__) D: ببینم... دهنتون رو باز کنید و بگید «آآآ». خیلی ملتهبه.\n\n۴. پیام به پذیرش (نوشتن)\nیک ایمیل کوتاه یا پیام واتساپ به منشی دکتر بنویسید و وقت بخواهید.\nشامل:\n• دلیل (مثلاً: چکاپ، کمردرد شدید).\n• ساعت‌های آزادتان (مثلاً: فقط بعدازظهر).\n• درخواست تأیید.",
        keywords: ["anamnesi","sala d'attesa","ricetta","sciroppo","Lei","formale","antibiotico","appuntamento","segreteria","WhatsApp"],
      },
      {
        heading: "Compito Role-Play — L'appuntamento con il medico (Pagine 78-80)",
        headingFa: "تکلیف نقش‌بازی — قرار ملاقات با دکتر",
        body: "Il role play (o gioco di ruolo) è una tecnica formativa, didattica o terapeutica che consiste nell'interpretazione di ruoli specifici all'interno di situazioni simulate, spesso simili a scenari reali. Questa metodologia permette di esplorare comportamenti, emozioni e dinamiche sociali in un ambiente protetto.\n\nRole-play al telefono:\nSimula una chiamata per spostare un appuntamento dal dentista o dal fisioterapista spiegando brevemente il problema fisico.\n\nScenario: \"L'amico a pezzi\"\nContesto: Marco chiama Giulia perché non è andato a lezione/lavoro.\n\nGiulia: Ciao Marco! Come mai non sei venuto oggi?\nMarco: Ciao Giulia... Eh, oggi sono a pezzi. Ho lavorato troppo ieri.\nGiulia: Mi dispiace! Ti senti solo stanco o hai anche l'influenza?\nMarco: Mi sento proprio giù. Mi fa male la testa e non sto in piedi.\nGiulia: Secondo me sei solo uno straccio perché non dormi abbastanza. Prendi un tè caldo e riposati!\nMarco: Hai ragione. Ora vado a letto. A domani!\n\nOra tocca a te! (Esercizio)\nCompleta queste frasi usando le espressioni date.\n\"Oggi non esco perché ho la febbre e sono a...\"\n\"Ho preso un brutto raffreddore, per questo sono...\"\n\"Dopo cominciare a correre, le mie gambe non... in piedi.\"\n\nConversazione: \"Dopo la palestra\"\nAmico: \"Ehi, come va? Ti va di fare una passeggiata in centro?\"\nTu: \"Ciao! Guarda, oggi preferisco restare sul divano. Sono a pezzi.\"\nAmico: \"Perché? Hai lavorato troppo?\"\nTu: \"No, ieri sono andato in palestra dopo tanto tempo e oggi mi fanno male tutti i muscoli.\"\nAmico: \"Ah, capisco! Hai i tipici dolori del giorno dopo.\"\nTu: \"Esatto. Non sto in piedi e mi fanno male soprattutto le gambe. Mi sento uno straccio!\"\nAmico: \"Allora riposati! Prendi un'aspirina o fai un bagno caldo.\"\nTu: \"Sì, ottima idea. Ci vediamo domani quando starò meglio!\"\n\nEspressioni utili: \"Ho i muscoli a pezzi\" / \"Mi fanno male i muscoli\" / \"Ho i dolori muscolari\"",
        bodyFa: "نقش‌بازی (یا بازی نقش) یک تکنیک آموزشی، تدریسی یا درمانی هست که شامل ایفای نقش‌های خاص در موقعیت‌های شبیه‌سازی‌شده، اغلب شبیه به سناریوهای واقعی هست. این روش اجازه می‌ده رفتارها، احساسات و پویایی‌های اجتماعی رو در یک محیط امن کاوش کنید.\n\nنقش‌بازی تلفنی:\nیک تماس رو شبیه‌سازی کنید برای جابه‌جایی وقت دندانپزشک یا فیزیوتراپ و مشکل جسمی رو مختصر توضیح بدید.\n\nسناریو: «دوست داغون»\nزمینه: مارکو به جولیا زنگ می‌زنه چون نرفته سر کلاس/کار.\n\nجولیا: سلام مارکو! چرا امروز نیومدی?\nمارکو: سلام جولیا... اه، امروز داغونم. دیروز خیلی کار کردم.\nجولیا: متأسفم! فقط خسته‌ای یا آنفولانزا هم گرفتی?\nمارکو: واقعاً حالم خرابه. سرم درد می‌کنه و سرپا نمی‌تونم وایستم.\nجولیا: به نظرم فقط یه دستمال کف‌شوری چون خوب نمی‌خوابی. یه چای داغ بخور و استراحت کن!\nمارکو: حق باهاته. الان میرم بخوابم. تا فردا!\n\nحالا نوبت تو! (تمرین)\nاین جملات رو با عبارات داده‌شده کامل کن.\n«امروز بیرون نمیرم چون تب دارم و هستم...»\n«سرماخوردگی بدی گرفتم، برای همین هستم...»\n«بعد از شروع دویدن، پاهام... سرپا نمی‌مونن.»\n\nمکالمه: «بعد از باشگاه»\nدوست: «سلام، چطوری? میای بریم یه قدم تو مرکز شهر?»\nتو: «سلام! ببین، امروز ترجیح می‌دم رو مبل بمونم. داغونم.»\nدوست: «چرا? زیاد کار کردی?»\nتو: «نه، دیروز بعد مدت‌ها رفتم باشگاه و امروز همه عضلاتم درد می‌کنه.»\nدوست: «آهان، فهمیدم! درد معمول روز بعد رو داری.»\nتو: «دقیقاً. سرپا نمی‌تونم وایستم و مخصوصاً پاهام درد می‌کنه. مثل یه دستمالم!»\nدوست: «پس استراحت کن! یه آسپیرین بخور یا یه حموم آب گرم بگیر.»\nتو: «آره، ایده عالیه. فردا می‌بینمت وقتی حالم بهتر شد!»\n\nعبارات مفید: «عضلاتم داغونه» / «عضلاتم درد می‌کنه» / «دردهای عضلانی دارم»",
        keywords: ["role play","gioco di ruolo","scenario","sono a pezzi","straccio","non sto in piedi","muscoli","palestra","aspirina"],
      },
      {
        heading: "Esercizi di Role-Play Medico (Pagine 81-82)",
        headingFa: "تمرین‌های نقش‌بازی پزشکی",
        body: "Abbiamo due esercizi di role-play per simulare una visita medica, con scenari e sintomi diversi.\n\nEsercizio 1: Influenza/Febbre (Situazione comune)\nScenario: Ti senti molto male da due giorni, hai febbre alta e tosse. Vai dal tuo medico di base.\nRuolo A (Paziente): Sei stanco, hai mal di gola e la febbre non scende.\nRuolo B (Medico): Devi fare domande specifiche per capire se si tratta di una semplice influenza o di qualcosa di più serio (es. COVID-19 o bronchite).\n\nFrasi chiave per il Paziente:\n\"Dottore, non mi sento per niente bene.\"\n\"Ho la febbre a 38.5 da due giorni.\"\n\"Ho una tosse secca che non mi fa dormire.\"\n\"Mi fa male dappertutto, specialmente la schiena.\"\n\nFrasi chiave per il Medico:\n\"Da quanto tempo ha questi sintomi?\"\n\"Ha preso qualcosa per la febbre?\"\n\"Le fa male quando respira?\"\n\"Respiri profondamente, per favore.\"\n\nEsercizio 2: Dolore Addominale/Problemi Digestivi\nScenario: Hai un forte dolore alla pancia e nausea dopo aver mangiato fuori ieri sera. Vai dal medico perché il dolore persiste.\nRuolo A (Paziente): Sei preoccupato e hai un dolore lancinante alla bocca dello stomaco.\nRuolo B (Medico): Devi indagare su cosa ha mangiato e verificare se ci sono segnali di intossicazione alimentare o altro.\n\nFrasi chiave per il Paziente:\n\"Ho un dolore forte qui, proprio sotto lo sterno.\"\n\"Ieri sera ho mangiato del pesce e poi ho iniziato a sentirmi male.\"\n\"Ho nausea e ho vomitato due volte.\"\n\"Il dolore va e viene, ma è molto intenso.\"\n\nFrasi chiave per il Medico:\n\"Il dolore è costante o a fitte?\"\n\"Ha febbre o diarrea?\"\n\"Si sdrai sul lettino, provo a premerle la pancia.\"\n\"Credo sia un'indigestione, le prescrivo qualcosa per lo stomaco.\"\n\nConsiglio per l'esercizio: Cerca di non usare appunti e di concentrarti sulla conversazione naturale. Se vuoi, registra l'esercizio per riascoltare la pronuncia e le strutture utilizzate.",
        bodyFa: "دو تمرین نقش‌بازی داریم برای شبیه‌سازی ویزیت پزشکی، با سناریوها و علائم مختلف.\n\nتمرین ۱: آنفولانزا/تب (موقعیت معمول)\nسناریو: دو روزه حالت خیلی بده، تب بالا و سرفه داری. میری پیش دکتر خانوادگی.\nنقش A (بیمار): خسته‌ای، گلودرد داری و تب پایین نمیاد.\nنقش B (دکتر): باید سؤالات خاص بپرسی تا بفهمی آنفولانزای ساده‌ست یا چیز جدی‌تر (مثلاً کرونا یا برونشیت).\n\nجملات کلیدی بیمار:\n«دکتر، اصلاً حالم خوب نیست.»\n«دو روزه تبم ۳۸.۵ هست.»\n«سرفه خشک دارم که نمی‌ذاره بخوابم.»\n«همه جام درد می‌کنه، مخصوصاً کمرم.»\n\nجملات کلیدی دکتر:\n«از کی این علائم رو دارید?»\n«چیزی برای تب خوردید?»\n«وقتی نفس می‌کشید درد دارید?»\n«لطفاً عمیق نفس بکشید.»\n\nتمرین ۲: درد شکم/مشکلات گوارشی\nسناریو: درد شدید شکم و حالت تهوع داری بعد از شام بیرون دیشب. میری دکتر چون درد ادامه داره.\nنقش A (بیمار): نگرانی و درد تیز سر معده داری.\nنقش B (دکتر): باید بپرسی چی خورده و بررسی کنی آیا نشانه‌های مسمومیت غذایی هست یا نه.\n\nجملات کلیدی بیمار:\n«اینجا درد شدید دارم، درست زیر جناغ سینه‌ام.»\n«دیشب ماهی خوردم و بعدش حالم بد شد.»\n«حالت تهوع دارم و دو بار استفراغ کردم.»\n«درد میاد و میره، ولی خیلی شدیده.»\n\nجملات کلیدی دکتر:\n«درد ثابته یا تیر می‌کشه?»\n«تب یا اسهال دارید?»\n«رو تخت دراز بکشید، شکمتون رو فشار بدم.»\n«فکر کنم سوءهاضمه باشه، یه چیزی برای معده‌تون تجویز می‌کنم.»\n\nتوصیه برای تمرین: سعی کنید از یادداشت استفاده نکنید و روی مکالمه طبیعی تمرکز کنید. اگه خواستید، تمرین رو ضبط کنید تا تلفظ و ساختارهای استفاده‌شده رو دوباره گوش بدید.",
        keywords: ["role-play","influenza","febbre","tosse","schiena","dolore addominale","nausea","stomaco","indigestione","intossicazione"],
      },
      // ── Page 83 ── Sezione 10: Addizioni Integrativi (intro)
      {
        heading: "Sezione 10 – Addizioni Integrativi",
        headingFa: "بخش ۱۰ – افزودنی‌های تکمیلی",
        body: "Imparare integrale attraverso canzoni, miti, racconti e braccialetti è un approccio educativo interdisciplinare che unisce musica, narrazione mitologica e tecnologia wearable per favorire l'apprendimento ludico e la creatività.\n\nQuesto metodo interdisciplinare trasforma l'apprendimento in un'esperienza multisensoriale che coinvolge corpo, mente e fantasia.",
        bodyFa: "یادگیری جامع از طریق آهنگ‌ها، اسطوره‌ها، داستان‌ها و دستبندها یک رویکرد آموزشی بین‌رشته‌ای است که موسیقی، روایت اسطوره‌ای و فناوری پوشیدنی را برای تقویت یادگیری بازی‌محور و خلاقیت ترکیب می‌کند.\n\nاین روش بین‌رشته‌ای، یادگیری را به یک تجربه چندحسی تبدیل می‌کند که بدن، ذهن و تخیل را درگیر می‌کند.",
        keywords: ["addizioni integrativi","interdisciplinare","canzoni","miti","racconti","multisensoriale"],
      },
      // ── Page 84 ── Citazioni famose sulla salute
      {
        heading: "Citazioni famose sulla salute",
        headingFa: "نقل‌قول‌های معروف درباره سلامتی",
        body: "«La salute è come il denaro, non abbiamo mai una vera idea del suo valore fino a quando la perdiamo.»\n\n«La salute non è tutto, ma senza salute tutto è niente.» — Arthur Schopenhauer\n\n«Se si riuscisse a dare a ciascuno la giusta dose di nutrimento ed esercizio fisico avremmo trovato la strada per la salute.» — Ippocrate\n\n«Se ci si prendesse cura della salute come ci prende cura del divertimento, nessuno si ammalerebbe mai.» — François Gervais\n\n«La malattia si può percepire, la salute no.» — Gerhard Uhlenbruck",
        bodyFa: "«سلامتی مثل پول است، تا وقتی از دستش ندهیم هیچ‌وقت ارزش واقعی‌اش را نمی‌فهمیم.»\n\n«سلامتی همه‌چیز نیست، اما بدون سلامتی همه‌چیز هیچ است.» — آرتور شوپنهاور\n\n«اگر بتوانیم به هر کسی مقدار مناسب تغذیه و ورزش بدهیم، راه سلامتی را پیدا کرده‌ایم.» — بقراط\n\n«اگر به اندازه‌ای که از تفریح مراقبت می‌کنیم از سلامتی‌مان مراقبت می‌کردیم، هیچ‌کس هرگز مریض نمی‌شد.» — فرانسوا ژروه\n\n«بیماری را می‌توان حس کرد، سلامتی را نه.» — گرهارد اولنبروک",
        keywords: ["citazioni","salute","denaro","Schopenhauer","Ippocrate","malattia","divertimento"],
      },
      // ── Page 85 ── Barzellette classiche dal medico
      {
        heading: "Barzellette classiche su chi va dal medico",
        headingFa: "جوک‌های کلاسیک درباره رفتن به دکتر",
        body: "Il paziente smemorato:\nUn uomo va dal dottore e dice: \"Dottore, ho un problema serio: mi dimentico tutto subito!\". Il medico lo guarda e chiede: \"E da quando le succede?\". E l'uomo: \"Da quando mi succede cosa?\"\n\nL'abitudine al fumo:\nUn paziente va dal medico per i risultati delle analisi. Il dottore dice: \"Ho una notizia buona e una cattiva. Quella cattiva è che le restano solo sei mesi di vita\". Il paziente, disperato: \"E quella buona?\". Il dottore: \"Vede quella bionda mozzafiato alla reception? Finalmente sono riuscito a uscirci insieme stasera!\"\n\nL'operazione:\nUn paziente sta per essere operato. È nervosissimo. Il chirurgo cerca di tranquillizzarlo: \"Stia sereno, è un intervento semplicissimo. Pensi che tra un'ora sarà già tutto finito e io potrò andare a giocare a golf\". Il paziente: \"E se qualcosa va storto?\". Il dottore: \"Non si preoccupi, per il golf ho l'appuntamento solo tra due ore, abbiamo tempo!\".\n\nLa mela al giorno:\n\"Dottore, lei mi aveva detto che mangiando una mela al giorno avrei tenuto il medico lontano...\". \"Sì, è vero, e allora?\". \"E allora niente, mi aiuti! Ho una mira pessima e l'ho colpita in pieno occhio!\".\n\nDolori dappertutto:\nUn signore entra nello studio medico e dice: \"Dottore, mi sento malissimo. Se mi tocco la testa col dito, mi fa male. Se mi tocco il ginocchio, mi fa male. Se mi tocco la pancia, mi fa male! Cosa può essere?\". Il medico lo visita e risponde: \"Semplice: ha il dito rotto\".\n\nProblemi di memoria:\nDue anziani parlano. Uno dice: \"Sono stato da un medico bravissimo per la memoria, mi ha dato delle pillole magiche!\". L'altro chiede: \"Ah sì? E come si chiama il dottore?\". L'amico ci pensa un po' e poi fa: \"Ehm... come si chiama quel fiore rosso, con le spine, molto profumato?\". \"La rosa?\". \"Sì, esatto!\". Poi si gira verso la cucina e urla: \"Rosa! Come si chiamava quel dottore?\".\n\nIl paziente ansioso:\n\"Dottore, dottore! Tutti mi ignorano!\". Il medico, senza alzare lo sguardo dalla scrivania: \"Avanti il prossimo!\".\n\nProblemi d'udito:\nUna donna va dal medico: \"Dottore, mio marito non mi sente più, cosa posso fare?\". Il medico suggerisce: \"Faccia una prova: si metta a distanza e gli faccia una domanda, poi si avvicini finché non le risponde\". La donna torna a casa, vede il marito di spalle in cucina e da 5 metri chiede: \"Caro, cosa c'è per cena?\". Nessuna risposta. Si avvicina a 3 metri: \"Caro, cosa c'è per cena?\". Nulla. Gli va proprio vicino e grida: \"Caro, cosa c'è per cena?\". E lui: \"Per la terza volta: POLLO!\".",
        bodyFa: "بیمار فراموشکار:\nمردی پیش دکتر می‌رود و می‌گوید: «دکتر، مشکل جدی دارم: همه‌چیز رو فوری یادم می‌ره!» دکتر نگاهش می‌کند و می‌پرسد: «از کی این مشکل رو دارید؟» مرد: «از کی چه مشکلی رو دارم؟»\n\nعادت به سیگار:\nبیماری برای نتایج آزمایش پیش دکتر می‌رود. دکتر می‌گوید: «یه خبر خوب دارم و یه خبر بد. خبر بد اینکه فقط شش ماه عمر دارید.» بیمار ناامید: «خبر خوب؟» دکتر: «اون خانم بلوند خوشگل پذیرش رو می‌بینید؟ بالاخره امشب باهاش قرار دارم!»\n\nعمل جراحی:\nبیماری قرار است عمل شود و خیلی عصبی است. جراح سعی می‌کند آرامش کند: «آروم باشید، عمل خیلی ساده‌ست. فکر کنید یه ساعت دیگه تموم شده و من می‌تونم برم گلف بازی کنم.» بیمار: «اگه مشکلی پیش بیاد چی؟» دکتر: «نگران نباشید، قرار گلف من دو ساعت دیگه‌ست، وقت داریم!»\n\nسیب روزانه:\n«دکتر، شما گفته بودید روزی یه سیب بخورم تا دکتر رو دور نگه دارم...» «بله، خب؟» «خب هیچی، کمکم کنید! نشونه‌گیریم خیلی بده و زدم تو چشمتون!»\n\nدرد همه‌جا:\nآقایی وارد مطب می‌شود: «دکتر، خیلی حالم بده. وقتی با انگشت سرم رو لمس می‌کنم درد می‌کنه. زانوم رو لمس می‌کنم درد می‌کنه. شکمم رو لمس می‌کنم درد می‌کنه!» دکتر معاینه می‌کند: «ساده‌ست: انگشتتون شکسته.»\n\nمشکل حافظه:\nدو پیرمرد حرف می‌زنند. یکی می‌گوید: «رفتم پیش یه دکتر عالی برای حافظه، قرص‌های جادویی بهم داد!» اون یکی: «اسم دکتره چیه؟» دوستش فکر می‌کند: «اِم... اسم اون گل قرمز خاردار خوشبو چیه؟» «رُز؟» «آره! دقیقاً!» بعد رو به آشپزخونه داد می‌زنه: «رُز! اسم اون دکتره چی بود؟»\n\nبیمار مضطرب:\n«دکتر، دکتر! همه نادیده‌ام می‌گیرن!» دکتر بدون اینکه سرش رو از روی میز بلند کنه: «نفر بعدی!»\n\nمشکل شنوایی:\nخانمی پیش دکتر می‌رود: «دکتر، شوهرم دیگه صدام رو نمی‌شنوه.» دکتر پیشنهاد می‌دهد: «یه آزمایش کنید: از دور سؤال بپرسید و نزدیک بشید تا جواب بده.» خانم برمی‌گردد خانه، شوهرش پشتش به اوست، از ۵ متری می‌پرسد: «عزیزم شام چی داریم؟» جوابی نمی‌آید. از ۳ متری: «عزیزم شام چی داریم؟» هیچی. می‌رود کنارش و داد می‌زند: «عزیزم شام چی داریم؟» شوهر: «برای بار سوم: مرغ!»",
        keywords: ["barzellette","paziente","dottore","operazione","memoria","udito","smemorato"],
      },
      // ── Page 86 ── Altre barzellette e umorismo medico
      {
        heading: "Ridere è la migliore medicina",
        headingFa: "خنده بهترین دارو است",
        body: "Dal Dottore – Barzelletta 1:\n\"Dottore, dottore...quando mi tocco la spalla mi fa male, quando tocco il mento mi fa male, quando tocco il ginocchio mi fa male...\" ed il dottore: \"ma cosa le è successo!?\" Il paziente: \"mi sono rotto il dito!!\".\n\nDal Dottore – Barzelletta 2:\n\"Dottore dottore, ma dopo questo intervento alla mano sarò in grado di suonare il violino?\"\n\"Certo, naturalmente!\"\n\"Fantastico! Non c'ero mai riuscito prima!\"\n\nBarzellette Pierino:\nLa maestra a Pierino: \"Pierino, nella frase <<il medico cura il paziente>>, dov'è il soggetto?\" e Pierino: \"all'ospedale signora maestra!\"\n\nIl dietologo:\nUn dietologo prescrive a una signora una cura dimagrante avvertendola che potrebbe avere qualche effetto collaterale. Dopo alcuni giorni la donna si ripresenta dal medico e dice:\n\"Dottore, la cura è sicuramente efficace, infatti ho già perso 5 kg, ma mi rende nervosa: pensi che ieri ho morso un orecchio a mio marito!\"\n\"Signora, non c'è nulla di cui preoccuparsi, un orecchio saranno sì e no 50 calorie...\"\n\nFra medici:\n\"Ho in cura una paziente molto giovane che sta perdendo la memoria... Che cosa mi consigli di fare?\"\n\"Di farti pagare in anticipo!\"\n\nRidere è la migliore medicina.\nMa se invece ridi senza motivo... hai bisogno di medicine!",
        bodyFa: "پیش دکتر – جوک ۱:\n«دکتر، دکتر... وقتی شونه‌ام رو لمس می‌کنم درد می‌کنه، چونه‌ام رو لمس می‌کنم درد می‌کنه، زانوم رو لمس می‌کنم درد می‌کنه...» دکتر: «چی شده؟!» بیمار: «انگشتم شکسته!!»\n\nپیش دکتر – جوک ۲:\n«دکتر، بعد از این عمل دست، می‌تونم ویولن بزنم؟»\n«البته، مسلماً!»\n«عالیه! قبلاً هیچ‌وقت بلد نبودم!»\n\nجوک پیرینو:\nمعلم به پیرینو: «پیرینو، در جمله «دکتر بیمار را درمان می‌کند»، فاعل کجاست؟» پیرینو: «تو بیمارستان، خانم معلم!»\n\nمتخصص رژیم:\nیک متخصص تغذیه برای خانمی رژیم لاغری تجویز می‌کند و هشدار می‌دهد که ممکن است عوارض جانبی داشته باشد. بعد از چند روز خانم برمی‌گردد:\n«دکتر، رژیم قطعاً مؤثره، ۵ کیلو کم کردم، ولی عصبیم می‌کنه: فکر کنید دیروز گوش شوهرم رو گاز گرفتم!»\n«خانم، نگران نباشید، یه گوش حداکثر ۵۰ کالریه...»\n\nبین پزشکان:\n«یه بیمار خیلی جوون دارم که حافظه‌اش داره از بین می‌ره... چه پیشنهادی داری؟»\n«بگو پیشاپیش پول بده!»\n\nخنده بهترین دارو است.\nاما اگه بی‌دلیل می‌خندی... به دارو نیاز داری!",
        keywords: ["ridere","medicina","barzellette","dietologo","effetto collaterale","Pierino","violino"],
      },
      // ── Page 87 ── Come danneggiano il tuo corpo le emozioni
      {
        heading: "Come danneggiano il tuo corpo le emozioni",
        headingFa: "احساسات چگونه به بدن شما آسیب می‌زنند",
        body: "Alcune persone sono come una medicina per l'anima. Basta passare un'ora con loro e tutto sembra andare meglio.\n\nLa salute non viene sempre dalla medicina. Il più delle volte viene dalla pace della mente, dalla pace nel cuore, dalla pace dell'anima. Viene dalle risate e dall'amore.\n\nDurante il parto il dolore è così forte che una donna può arrivare ad immaginare come si senta un uomo con la febbre.\n\nÈ nei corridoi degli ospedali che capiamo cos'è la vita.\n\nCome danneggiano il tuo corpo le emozioni?\n• La rabbia indebolisce il tuo fegato.\n• Il dolore indebolisce i polmoni.\n• La preoccupazione indebolisce lo stomaco.\n• Lo stress indebolisce il cuore e il cervello.\n• La paura indebolisce i reni.",
        bodyFa: "بعضی آدم‌ها مثل یک دارو برای روح هستند. کافیه یه ساعت باهاشون باشی و همه‌چیز بهتر به نظر می‌رسه.\n\nسلامتی همیشه از دارو نمیاد. بیشتر وقت‌ها از آرامش ذهن، آرامش قلب و آرامش روح میاد. از خنده و عشق میاد.\n\nدرد زایمان آنقدر شدید است که یک زن می‌تواند تصور کند یک مرد با تب چه حالی دارد.\n\nدر راهروهای بیمارستان است که می‌فهمیم زندگی چیست.\n\nاحساسات چگونه به بدن شما آسیب می‌زنند؟\n• خشم کبد شما را ضعیف می‌کند.\n• درد ریه‌ها را ضعیف می‌کند.\n• نگرانی معده را ضعیف می‌کند.\n• استرس قلب و مغز را ضعیف می‌کند.\n• ترس کلیه‌ها را ضعیف می‌کند.",
        keywords: ["emozioni","rabbia","fegato","dolore","polmoni","stress","cuore","cervello","paura","reni"],
      },
      // ── Page 88 ── Sezione 11: Leggere un po di più (intro)
      {
        heading: "Sezione 11 – Leggere un po di più",
        headingFa: "بخش ۱۱ – کمی بیشتر بخوانیم",
        body: "L'appuntamento con il medico.\n\nLeggere è un potente strumento di training, poiché attiva numerosi processi cognitivi come attenzione, memoria di lavoro e comprensione.\n\nQuesto metodo permette di approfondire lezioni apprese in esperienze concrete, facilitate da una struttura narrativa causa-effetto.",
        bodyFa: "قرار ملاقات با پزشک.\n\nخواندن یک ابزار قدرتمند آموزشی است، زیرا فرآیندهای شناختی متعددی مانند توجه، حافظه کاری و درک مطلب را فعال می‌کند.\n\nاین روش امکان تعمیق درس‌های آموخته‌شده در تجربیات عملی را فراهم می‌کند، که توسط ساختار روایی علت و معلولی تسهیل می‌شود.",
        keywords: ["leggere","training","attenzione","memoria","comprensione","struttura narrativa","causa-effetto"],
      },
      // ── Page 89 ── Lettura: Sara, il sushi e la visita medica
      {
        heading: "Sara, il sushi e la visita medica",
        headingFa: "سارا، سوشی و ویزیت پزشکی",
        body: "È lunedì mattina. Sara è nel suo letto, ma non vuole alzarsi. Ha un mal di pancia fortissimo. La sua faccia è un po' verde. Ieri sera è andata a un ristorante \"All You Can Eat\" con i suoi amici e ha mangiato 30 pezzi di sushi, 4 gamberetti fritti e un gelato al tè verde.\nSara prova a bere un tè caldo, ma il dolore non passa. Decide di andare dal medico.\n\nIn clinica\nSara arriva alla clinica alle 10:30. In sala d'attesa ci sono molte persone:\nUn signore anziano che legge il giornale.\nUna ragazza con il braccio rotto.\nUn bambino che piange.\nDopo quindici minuti, l'infermiera dice: \"Signorina Sara, il dottore la aspetta\".\n\nLa visita\nSara entra nello studio. Il dottor Bianchi è un uomo gentile con i capelli bianchi.\n— \"Buongiorno Sara, come stai?\" chiede il dottore.\n— \"Buongiorno dottore. Sto male. Ho molta nausea e la mia pancia è gonfia come un pallone,\" risponde Sara.\nIl dottore dice: \"Sdraiati sul lettino, per favore\". Il medico preme sulla pancia di Sara.\n— \"Qui fa male?\" chiede lui.\n— \"Ahi! Sì, molto!\" grida Sara.\n\nLa diagnosi e la cura\nIl dottore si lava le mani e sorride.\n— \"Non è un virus. È solo una brutta indigestione. Hai mangiato troppo cibo crudo e fritto.\"\nIl dottore prende una penna e scrive la ricetta:\nMedicina: Una compressa dopo i pasti per tre giorni.\nDieta: Solo cibo leggero (riso in bianco, carote bollite, banane).\nRiposo: Dormire molto e bere tanta acqua.\n\nSara esce dallo studio e va in farmacia. Compra le medicine e torna a casa. Per tre giorni mangia solo riso bollito. Finalmente, il quarto giorno, Sara sta bene. Chiama la sua amica e dice: \"Stasera usciamo, ma per favore... andiamo a mangiare una semplice insalata!\"\n\nVocabolario:\nNausea: quando senti che vuoi rimettere (vomitare).\nGonfia: quando la pancia è grande perché piena di aria o cibo.\nLettino: il letto piccolo nello studio del medico.\nCompressa: una pillola, un tipo di medicina.\nCibo leggero: cibo semplice che non fa male allo stomaco.",
        bodyFa: "صبح دوشنبه است. سارا توی تختشه، ولی نمی‌خواد بلند بشه. دل‌درد خیلی شدیدی داره. صورتش یه کم سبز شده. دیشب با دوستاش رفته بود رستوران «هر چقدر می‌تونی بخور» و ۳۰ تکه سوشی، ۴ میگوی سرخ‌شده و یه بستنی چای سبز خورده بود.\nسارا سعی می‌کنه یه چای داغ بخوره، ولی درد قطع نمی‌شه. تصمیم می‌گیره بره دکتر.\n\nدر کلینیک\nسارا ساعت ۱۰:۳۰ به کلینیک می‌رسه. تو سالن انتظار آدمای زیادی هستند:\nیه آقای مسن که روزنامه می‌خونه.\nیه دختر با دست شکسته.\nیه بچه که گریه می‌کنه.\nبعد از پانزده دقیقه، پرستار می‌گه: «خانم سارا، دکتر منتظرتونه.»\n\nویزیت\nسارا وارد مطب می‌شه. دکتر بیانکی مرد مهربانی با موهای سفیده.\n— «سلام سارا، حالت چطوره؟» دکتر می‌پرسه.\n— «سلام دکتر. حالم بده. خیلی حالت تهوع دارم و شکمم مثل بادکنک باد کرده،» سارا جواب می‌ده.\nدکتر می‌گه: «رو تخت دراز بکش لطفاً.» دکتر روی شکم سارا فشار می‌ده.\n— «اینجا درد می‌کنه؟» می‌پرسه.\n— «آی! بله، خیلی!» سارا داد می‌زنه.\n\nتشخیص و درمان\nدکتر دست‌هاش رو می‌شوره و لبخند می‌زنه.\n— «ویروس نیست. فقط یه سوءهاضمه بد. خیلی زیاد غذای خام و سرخ‌شده خوردی.»\nدکتر یه خودکار برمی‌داره و نسخه می‌نویسه:\nدارو: یه قرص بعد از هر وعده غذا به مدت سه روز.\nرژیم: فقط غذای سبک (برنج ساده، هویج آب‌پز، موز).\nاستراحت: زیاد بخواب و آب زیاد بخور.\n\nسارا از مطب بیرون میاد و می‌ره داروخانه. داروها رو می‌خره و برمی‌گرده خونه. سه روز فقط برنج آب‌پز می‌خوره. بالاخره روز چهارم، سارا حالش خوبه. به دوستش زنگ می‌زنه و می‌گه: «امشب بریم بیرون، ولی لطفاً... بریم یه سالاد ساده بخوریم!»\n\nواژگان:\nحالت تهوع (Nausea): وقتی حس می‌کنی می‌خوای بالا بیاری.\nباد کرده (Gonfia): وقتی شکم بزرگ شده چون پر از هوا یا غذاست.\nتخت معاینه (Lettino): تخت کوچک توی مطب دکتر.\nقرص (Compressa): یه نوع دارو به شکل قرص.\nغذای سبک (Cibo leggero): غذای ساده که به معده آسیب نمی‌زنه.",
        keywords: ["sushi","visita medica","nausea","gonfia","lettino","compressa","cibo leggero","indigestione","ricetta"],
      },
      // ── Page 90 ── Lettura: Paolo ha l'influenza
      {
        heading: "Paolo ha l'influenza",
        headingFa: "پائولو آنفولانزا دارد",
        body: "Oggi Paolo non va al lavoro. Si sveglia alle otto, ma si sente molto stanco. Ha un forte mal di testa e sente freddo, anche se ha due coperte.\nPaolo prende il termometro: la febbre è a 38.5. Oltre alla febbre, Paolo ha mal di corpo: gli fanno male le braccia, le gambe e la schiena. Sembra che abbia corso una maratona, ma è solo rimasto a letto!\n\nPaolo chiama il suo medico:\n— \"Pronto, dottore? Ho la febbre alta e mi fa male tutto il corpo.\"\n— \"Buongiorno Paolo. Hai anche la tosse?\" chiede il medico.\n— \"Sì, un po', e ho anche il mal di gola.\"\n\nIl dottore spiega: \"Paolo, tu hai l'influenza. Quest'anno è molto forte. Devi stare a riposo per cinque giorni.\"\nIl dottore dà dei consigli a Paolo:\nPrendi una medicina per la febbre (la tachipirina).\nBevi molto: acqua, spremuta d'arancia e brodo caldo.\nResta a letto al caldo.\n\nPaolo è triste perché non può uscire con i suoi amici, ma sa che il riposo è importante. Beve un bicchiere di acqua con il limone e si addormenta subito. Dopo tre giorni, la febbre scende e il mal di corpo scompare. Paolo è felice: finalmente può tornare a camminare e a mangiare con appetito.\n\nVocabolario:\nInfluenza: una malattia comune in inverno (febbre, tosse, stanchezza).\nMal di corpo: quando i muscoli e le ossa fanno male.\nBrividi: quando senti freddo e il corpo trema.\nSpremuta d'arancia: succo di frutta fresco con vitamina C.\nRiposo: non lavorare, dormire e stare tranquilli.",
        bodyFa: "امروز پائولو سر کار نمی‌ره. ساعت هشت بیدار می‌شه ولی خیلی خسته‌ست. سردرد شدیدی داره و احساس سرما می‌کنه، حتی با دو تا پتو.\nپائولو دماسنج رو برمی‌داره: تبش ۳۸.۵ هست. علاوه بر تب، بدن‌درد هم داره: دست‌ها، پاها و کمرش درد می‌کنه. انگار ماراتن دویده، ولی فقط تو تخت مونده!\n\nپائولو به دکترش زنگ می‌زنه:\n— «الو، دکتر؟ تب بالا دارم و همه جای بدنم درد می‌کنه.»\n— «سلام پائولو. سرفه هم داری؟» دکتر می‌پرسه.\n— «بله، یه کم، گلودرد هم دارم.»\n\nدکتر توضیح می‌ده: «پائولو، آنفولانزا داری. امسال خیلی شدیده. باید پنج روز استراحت کنی.»\nدکتر به پائولو توصیه‌هایی می‌کنه:\nیه دارو برای تب بخور (تاکی‌پیرینا).\nزیاد مایعات بخور: آب، آب‌پرتقال تازه و آبگوشت داغ.\nتو تخت بمون و گرم باش.\n\nپائولو ناراحته چون نمی‌تونه با دوستاش بره بیرون، ولی می‌دونه استراحت مهمه. یه لیوان آب‌لیمو می‌خوره و فوری خوابش می‌بره. بعد از سه روز، تب می‌افته و بدن‌درد از بین می‌ره. پائولو خوشحاله: بالاخره می‌تونه دوباره راه بره و با اشتها غذا بخوره.\n\nواژگان:\nآنفولانزا (Influenza): بیماری رایج زمستانی (تب، سرفه، خستگی).\nبدن‌درد (Mal di corpo): وقتی ماهیچه‌ها و استخوان‌ها درد می‌کنند.\nلرز (Brividi): وقتی احساس سرما می‌کنی و بدنت می‌لرزه.\nآب‌پرتقال تازه (Spremuta d'arancia): آبمیوه تازه با ویتامین C.\nاستراحت (Riposo): کار نکردن، خوابیدن و آروم بودن.",
        keywords: ["influenza","febbre","mal di corpo","brividi","tachipirina","spremuta","riposo","brodo","tosse"],
      },
      // ── Pages 91–96 (Part 1) ──
      ...dalMedicoPart1,
      // ── Pages 97–102 (Part 2) ──
